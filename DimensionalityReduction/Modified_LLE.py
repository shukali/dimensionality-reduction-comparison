...
def fit_transform(X_highdimensional, n_neighbors=5):
    '''
        Performs Modified LLE on the given highdimensional dataset. The data needs to be a numpy array of the form (n_samples, n_features).
    ...
    '''
    mlle = manifold.LocallyLinearEmbedding(n_neighbors, n_components=2, method='modified', eigen_solver='dense')
    t0 = time()
    X_low = mlle.fit_transform(X_highdimensional)
    return X_low, (time() - t0), mlle.reconstruction_error_